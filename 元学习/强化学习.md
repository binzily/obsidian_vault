...
## 5.强化学习算法大一统
| Object（主要学什么）               | 祖公式/不变量（你要记住的那条）                                                                                                                                                                                                                                         | 估计器（训练信号从哪来）                                                                                                                                                                                                          | 稳定器（典型防崩机制）                                                                                                                                                                                                                 | 代表算法（经典）                                                                                                                                                                                                                     | 代表算法（现代/LLM）                                                                                                                                                                                         |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Policy π（随机策略）              | (\nabla_\theta J=\mathbb{E}[\nabla_\theta\log\pi_\theta(a                                                                                                                                                                                                | s),(\cdot)])（policy gradient / REINFORCE 主干） ([Springer](https://link.springer.com/article/10.1007/BF00992696?utm_source=chatgpt.com "Simple statistical gradient-following algorithms for connectionist ..."))       | 用 return-to-go (G_t) 或 advantage (\hat A_t) 代替整轨迹回报（降方差） ([Springer](https://link.springer.com/article/10.1007/BF00992696?utm_source=chatgpt.com "Simple statistical gradient-following algorithms for connectionist ...")) | 信任域/裁剪/KL（控制更新幅度） ([arXiv](https://arxiv.org/abs/1502.05477?utm_source=chatgpt.com "[1502.05477] Trust Region Policy Optimization - arXiv.org"))                                                                             | REINFORCE、TRPO、PPO ([Springer](https://link.springer.com/article/10.1007/BF00992696?utm_source=chatgpt.com "Simple statistical gradient-following algorithms for connectionist ..."))                |
| Actor-Critic（π + V/Q）       | Actor：($\mathbb{E}[\nabla\log\pi\cdot A]$)；Critic：贝尔曼不动点/TD 误差                                                                                                                                                                                           | (\hat A) 的估计器：TD、n-step、GAE ([arXiv](https://arxiv.org/abs/1506.02438?utm_source=chatgpt.com "High-Dimensional Continuous Control Using Generalized Advantage Estimation"))                                           | on-policy：PPO clip/KL；off-policy：target/Polyak、双Q、replay ([arXiv](https://arxiv.org/abs/1707.06347?utm_source=chatgpt.com "[1707.06347] Proximal Policy Optimization Algorithms - arXiv.org"))                              | A2C/A3C、PPO、SAC ([arXiv](https://arxiv.org/abs/1707.06347?utm_source=chatgpt.com "[1707.06347] Proximal Policy Optimization Algorithms - arXiv.org"))                                                                        | 许多 LLM “XXXPO”本质是“无/弱 critic 的 actor-critic 变体”                                                                                                                                                      |
| Value/Q（评估 (V^\pi,Q^\pi)）   | 贝尔曼期望方程：(V^\pi(s)=\mathbb{E}[r+\gamma V^\pi(s')]) ([Stanford University](https://web.stanford.edu/class/psych209/Readings/SuttonBartoIPRLBook2ndEd.pdf?utm_source=chatgpt.com "Reinforcement Learning: An Introduction - Stanford University"))          | TD(0)/n-step/λ（偏差-方差旋钮） ([Stanford University](https://web.stanford.edu/class/psych209/Readings/SuttonBartoIPRLBook2ndEd.pdf?utm_source=chatgpt.com "Reinforcement Learning: An Introduction - Stanford University")) | target network / replay（函数逼近下稳态） ([谷歌云存储](https://storage.googleapis.com/deepmind-media/dqn/DQNNaturePaper.pdf?utm_source=chatgpt.com "Human-level control through deep reinforcement learning"))                           | TD、SARSA、各类 critic 训练 ([Stanford University](https://web.stanford.edu/class/psych209/Readings/SuttonBartoIPRLBook2ndEd.pdf?utm_source=chatgpt.com "Reinforcement Learning: An Introduction - Stanford University"))          | LLM 里较少单独作为主角（多当 critic/基线）                                                                                                                                                                          |
| Optimal Q*（最优控制）            | 贝尔曼最优方程：(Q^_(s,a)=\mathbb{E}[r+\gamma\max_{a'}Q^_(s',a')]) ([Stanford University](https://web.stanford.edu/class/psych209/Readings/SuttonBartoIPRLBook2ndEd.pdf?utm_source=chatgpt.com "Reinforcement Learning: An Introduction - Stanford University")) | Q-target（max / Double / min-double-Q / soft backup） ([谷歌云存储](https://storage.googleapis.com/deepmind-media/dqn/DQNNaturePaper.pdf?utm_source=chatgpt.com "Human-level control through deep reinforcement learning"))  | target network、Double、分布式回报等 ([谷歌云存储](https://storage.googleapis.com/deepmind-media/dqn/DQNNaturePaper.pdf?utm_source=chatgpt.com "Human-level control through deep reinforcement learning"))                               | Q-learning、DQN ([谷歌云存储](https://storage.googleapis.com/deepmind-media/dqn/DQNNaturePaper.pdf?utm_source=chatgpt.com "Human-level control through deep reinforcement learning"))                                              | 离线/对齐场景会被改成“保守 Q”（见下）                                                                                                                                                                                |
| 正则化目标（KL / 熵）               | KL 正则：(\max \mathbb{E}[R]-\beta KL(\pi\|\pi_{ref}))（RLHF 常见写法）；最大熵：(\max \mathbb{E}[R+\alpha H]) ([arXiv](https://arxiv.org/abs/2203.02155?utm_source=chatgpt.com "Training language models to follow instructions with human feedback"))                | KL/熵项如何估计（token vs sequence；是否组内归一化）                                                                                                                                                                                  | KL penalty/constraint、clip、温度门控 ([arXiv](https://arxiv.org/abs/1707.06347?utm_source=chatgpt.com "[1707.06347] Proximal Policy Optimization Algorithms - arXiv.org"))                                                       | SAC（熵） ([arXiv](https://arxiv.org/abs/1801.01290?utm_source=chatgpt.com "Soft Actor-Critic: Off-Policy Maximum Entropy Deep Reinforcement Learning with a Stochastic Actor"))                                                | PPO-RLHF、GSPO/SAPO/DAPO（多在这条线上改“估计器+稳定器”） ([arXiv](https://arxiv.org/abs/2203.02155?utm_source=chatgpt.com "Training language models to follow instructions with human feedback"))                   |
| Off-policy 修正（分布错配）         | 重要性采样比率 (\rho=\pi/\mu)；V-trace 修正（高吞吐 actor-learner） ([arXiv](https://arxiv.org/abs/1802.01561?utm_source=chatgpt.com "[1802.01561] IMPALA: Scalable Distributed Deep-RL with Importance ..."))                                                          | IS / V-trace / Retrace 等（修正“采样策略≠更新策略”） ([arXiv](https://arxiv.org/abs/1802.01561?utm_source=chatgpt.com "[1802.01561] IMPALA: Scalable Distributed Deep-RL with Importance ..."))                                    | 截断比率、稳定的目标构造 ([arXiv](https://arxiv.org/abs/1802.01561?utm_source=chatgpt.com "[1802.01561] IMPALA: Scalable Distributed Deep-RL with Importance ..."))                                                                     | IMPALA ([arXiv](https://arxiv.org/abs/1802.01561?utm_source=chatgpt.com "[1802.01561] IMPALA: Scalable Distributed Deep-RL with Importance ..."))                                                                            | LLM 里 token/sequence ratio 的设计本质上也在处理分布错配（GSPO 明确强调 sequence-level） ([arXiv](https://arxiv.org/abs/2507.18071?utm_source=chatgpt.com "[2507.18071] Group Sequence Policy Optimization - arXiv.org")) |
| Offline RL（只用固定数据集）         | 核心痛点：OOD 动作导致 Q 过估计；保守目标：让 Q 更“下界” ([arXiv](https://arxiv.org/abs/2006.04779?utm_source=chatgpt.com "Conservative Q-Learning for Offline Reinforcement Learning"))                                                                                       | 保守项/优势加权/行为克隆混合等                                                                                                                                                                                                      | 保守正则、约束策略远离数据分布外动作 ([arXiv](https://arxiv.org/abs/2006.04779?utm_source=chatgpt.com "Conservative Q-Learning for Offline Reinforcement Learning"))                                                                          | CQL ([arXiv](https://arxiv.org/abs/2006.04779?utm_source=chatgpt.com "Conservative Q-Learning for Offline Reinforcement Learning"))                                                                                          | 偏好数据/离线对齐常借鉴这一族（尤其“防跑偏”思路）                                                                                                                                                                           |
| Model（环境模型 (\hat P,\hat r)） | (\max_\psi \mathbb{E}[\log \hat P_\psi(s'                                                                                                                                                                                                                | s,a)])（或回归）；再用模型做规划/造数据（Dyna） ([derongliu.org](https://www.derongliu.org/adp/adp-cdrom/refs/sutton19900216.pdf?utm_source=chatgpt.com "Integrated Architectures for Learning, Planning, and Reacting Based on ..."))  | one-step / short rollout；不确定性估计等                                                                                                                                                                                            | 短 rollout、ensemble、MPC 重规划等（抑制模型误差累积） ([derongliu.org](https://www.derongliu.org/adp/adp-cdrom/refs/sutton19900216.pdf?utm_source=chatgpt.com "Integrated Architectures for Learning, Planning, and Reacting Based on ...")) | Dyna ([derongliu.org](https://www.derongliu.org/adp/adp-cdrom/refs/sutton19900216.pdf?utm_source=chatgpt.com "Integrated Architectures for Learning, Planning, and Reacting Based on ..."))          |
| Preference 优化（不一定是 RL）      | 有些方法直接用偏好做监督式目标，避免 rollout（DPO） ([arXiv](https://arxiv.org/abs/2305.18290?utm_source=chatgpt.com "Direct Preference Optimization: Your Language Model is Secretly a Reward Model"))                                                                      | 分类/对比损失                                                                                                                                                                                                               | 稳定、低成本（但不属于“在线 RL rollouts”） ([arXiv](https://arxiv.org/abs/2305.18290?utm_source=chatgpt.com "Direct Preference Optimization: Your Language Model is Secretly a Reward Model"))                                            | —                                                                                                                                                                                                                            | DPO（常被拿来替代 PPO-RLHF） ([arXiv](https://arxiv.org/abs/2305.18290?utm_source=chatgpt.com "Direct Preference Optimization: Your Language Model is Secretly a Reward Model"))                             |